...
void Point::setX(double new_x) { _x = new_x; }

void Point::setY(double new_y) { _y = new_y; }

void Point::setZ(double new_z) { _z = new_z; }
...
double Point::vector_len() const { return sqrt(_x * _x + _y * _y + _z * _z); }
