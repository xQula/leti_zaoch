...
Point Camera::o() const { return O; }

Point Camera::f() const { return F; }

Point Camera::u() const { return U; }

Point Camera::r() const { return R; }
...
void Camera::rotateOX(double a) { rotate(a, 1); }

void Camera::rotateOY(double a) { rotate(a, 2); }

void Camera::rotateOZ(double a) { rotate(a, 3); }
...
void Camera::moveBack(double s) { moveForward(-s); }
...
void Camera::moveLeft(double s) { moveRight(-s); }
...
void Camera::moveDown(double s) { moveUp(-s); }
